package com.bupt.xkc.historytoday.swipebacklayout.lib;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    public static final int EDGE_LEFT = me.imid.swipebacklayout.lib.ViewDragHelper.EDGE_LEFT;

    /**
     * Edge flag indicating that the right edge should be affected.
     */
    public static final int EDGE_RIGHT = me.imid.swipebacklayout.lib.ViewDragHelper.EDGE_RIGHT;

    /**
     * Edge flag indicating that the bottom edge should be affected.
     */
    public static final int EDGE_BOTTOM = me.imid.swipebacklayout.lib.ViewDragHelper.EDGE_BOTTOM;
     ...
     * fling/snap.
     */
    public static final int STATE_IDLE = me.imid.swipebacklayout.lib.ViewDragHelper.STATE_IDLE;

    /**
     * A view is currently being dragged. The position is currently changing as
     * a result of user input or simulated user input.
     */
    public static final int STATE_DRAGGING = me.imid.swipebacklayout.lib.ViewDragHelper.STATE_DRAGGING;

    /**
     * A view is currently settling into place as a result of a fling or
     * predefined non-interactive motion.
     */
    public static final int STATE_SETTLING = me.imid.swipebacklayout.lib.ViewDragHelper.STATE_SETTLING;
    ...
    private me.imid.swipebacklayout.lib.ViewDragHelper mDragHelper;
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
        mDragHelper = me.imid.swipebacklayout.lib.ViewDragHelper.create(this, new ViewDragCallback());

        TypedArray a = context.obtainStyledAttributes(attrs, me.imid.swipebacklayout.lib.R.styleable.SwipeBackLayout, defStyle,
        ...
        int mode = EDGE_FLAGS[a.getInt(me.imid.swipebacklayout.lib.R.styleable.SwipeBackLayout_edge_flag, 0)];
        setEdgeTrackingEnabled(mode);

        int shadowLeft = a.getResourceId(me.imid.swipebacklayout.lib.R.styleable.SwipeBackLayout_shadow_left,
                me.imid.swipebacklayout.lib.R.drawable.shadow_left);
        int shadowRight = a.getResourceId(me.imid.swipebacklayout.lib.R.styleable.SwipeBackLayout_shadow_right,
                me.imid.swipebacklayout.lib.R.drawable.shadow_right);
        int shadowBottom = a.getResourceId(me.imid.swipebacklayout.lib.R.styleable.SwipeBackLayout_shadow_bottom,
                me.imid.swipebacklayout.lib.R.drawable.shadow_bottom);
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (mScrimOpacity > 0 && drawContent
                && mDragHelper.getViewDragState() != me.imid.swipebacklayout.lib.ViewDragHelper.STATE_IDLE) {
    ...
    private class ViewDragCallback extends me.imid.swipebacklayout.lib.ViewDragHelper.Callback {
        ...
        public boolean tryCaptureView(View view, int i) {
            ...
            if (mEdgeFlag == EDGE_LEFT || mEdgeFlag == EDGE_RIGHT) {
                directionCheck = !mDragHelper.checkTouchSlop(me.imid.swipebacklayout.lib.ViewDragHelper.DIRECTION_VERTICAL, i);
            } else if (mEdgeFlag == EDGE_BOTTOM) {
                directionCheck = !mDragHelper
                        .checkTouchSlop(me.imid.swipebacklayout.lib.ViewDragHelper.DIRECTION_HORIZONTAL, i);
